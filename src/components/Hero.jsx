...
const Hero = () => {
  return (
    <div className='flex justify-center '>
        <div className='lg:w-[75%] w-[95%] flex justify-between gap-[60px] border-t-[85px] border-b-[85px] border-white'>
      <div className='flex flex-col justify-center'>
        <div className="badge badge-soft badge-primary">
            <img src={dot} alt="" />
            <p>New: AI-Powered Tools Available</p></div>
            <p className='lg:text-[72px] text-[40px] font-[800]'>Supercharge Your Digital Workflow</p>
