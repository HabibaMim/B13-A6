  ...
  return (
    <div className='bg-[#F1F1F1]'>
      <div className=' border-t-[120px] border-[#F1F1F1] flex flex-col justify-center items-center'>
        <p className='text-[48px] font-[800] text-center'>Get Started in 3 Steps</p>
        <p className='text-gray-400'>Start using premium digital tools in minutes, not hours.</p>
        </div>
      <div className='grid md:grid-cols-1 lg:flex gap-[30px] justify-center border-t-[40px] border-[#F1F1F1] border-b-[120px]'>
